<%-- 
    ...
    Created on : Dec 27, 2020, 3:32:11 PM
    Author     : AKILA
--%>
...
<html lang="en">
    <head>
        <title>404 Page Not Found | <%=DataHolders.ProjectInfo.getAppTitle()%></title>
        ...
        <link rel="stylesheet" type="text/css" href="assets/css/errorpages_styles.css">
    ...
    <body>
        ...
        <div class="error">
            ...
            <div class="error__description">We could not find the page you were looking for...</div>
            <button class="error__button error__button--active" onclick='window.top.location.href = "index.jsp";'><span class="fa fa-reply"></span>&nbsp;&nbsp;Go Back</button>
        </div>
