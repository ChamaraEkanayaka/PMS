<%-- 
    Document   : errorPage_500
    Created on : Dec 27, 2020, 3:32:19 PM
    Author     : AKILA
--%>
...
<html lang="en">
    <head>
        <title>500 ERROR | <%=DataHolders.ProjectInfo.getAppTitle()%></title>
    ...
    <body>
        <div class="container">
            <div class="error">
                ...
                <p>We will work on fixing that right away. Meanwhile, you may return to main page.</p>
                <a href="#" class="btn btn-info btn-default" onclick='window.top.location.href = "index.jsp";'><span class="fa fa-reply"></span> Go Back</a>
            </div>
