    ...
    try {
        if (request.getSession().getAttribute("LOGIN_DATA") != null) {
            ...
            if (!STAFF_NAME.equals("") && !USER_NAME.equals("") && !BRANCH_NAME.equals("") && USER_ID > 0 && BRANCH_ID > 0) {
                ...
                if (!User_AccessOBJECT.getAd().contains("T")) {
...
<html lang="en">
    <head>
        <title>Patient List | <%=MAIN_NAME%></title>
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="page-header-title">
                                                        <div class="d-inline">
                                                            ...
                                                            <span>Search, View Patients Records & Details.</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="page-header-breadcrumb">
                                                        <ul class="breadcrumb-title">
                                                            ...
                                                            <li class="breadcrumb-item"><a href="patient_list.jsp">Patient List</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <script type="text/javascript">
            function load_SearchResults_DataTable() {
                ...
                $('#DataTable_Includer').load('report_PatientsReport_DataTable.jsp?' +
                        ...
                        "&param_DateFrom=" + param_DateFrom + "&param_DateTo=" + param_DateTo  + "&param_Patient=" + param_Patient);
            }
        </script>
    </body>
</html>
