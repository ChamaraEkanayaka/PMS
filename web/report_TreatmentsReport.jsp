                                                                                ...
                                                                                <th style="width: 100%;">
                                                                                    <select class="form-control" id="TokenNo">
                                                                                        ...
                                                                                        <%  Criteria cr_PtnTokenNo = sess.createCriteria(PatientToken.class);
                                                                                            cr_PtnTokenNo.add(Restrictions.eq("status", 1));
                                                                                            cr_PtnTokenNo.addOrder(Order.asc("tokenNumber"));
                                                                                            List<PatientToken> ptnTokenNo_List = cr_PtnTokenNo.list();
                                                                                            for (PatientToken PrescTokenNo_OBJ : ptnTokenNo_List) {%>
                                                                                        <option value="<%=PrescTokenNo_OBJ.getTokenNumber()%>"><%=PrescTokenNo_OBJ.getTokenNumber()%></option>
                                                                                        <% }%>
                                                                                    </select>
                                                                                </th>
                                                                            </tr>
