...
public class Stock  implements java.io.Serializable {
    ...
    public Stock(Branch branch, Items items, double qty, int status, String date, Double cost, Double price, String time, Set prescriptionItems, Set saleInvoiceItems, Set holdInvoiceItems, Set returnItems, Set quotationInvoiceItems, Set stockTransfers, Set stockDamages, Set stockPrices) {
       this.branch = branch;
       this.items = items;
       this.qty = qty;
       this.status = status;
